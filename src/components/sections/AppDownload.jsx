          ...
          <div className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg pointer-events-auto reveal-left">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              ...
              <a
                id="btn-google-play"
                href="#download"
                className="btn-shimmer bg-white hover:bg-amber-50 text-black px-4 sm:px-5 py-2.5 sm:py-3.5 rounded-xl flex items-center gap-3 shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(0,0,0,0.6)] active:scale-95 group"
              >
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className="font-extrabold text-xs sm:text-sm md:text-base leading-none text-black">
                    Google Play
                  </span>
                </div>
              </a>
